...
public class ArmMotors extends Subsystem {
    ...
    private final CANTalon pickupLifterMotor = RobotMap.armMotorspickupLifterMotor;
    private final CANTalon pickupWristMotor = RobotMap.armMotorspickupWristMotor;
    private final SpeedController pickupWheels = RobotMap.armMotorspickupWheels;
    ...
    public void spinIntakeWheels(double power){
