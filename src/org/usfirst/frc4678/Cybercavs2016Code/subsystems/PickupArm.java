...
public class PickupArm extends Subsystem {
	...
	int wristHoldPosition = pickupWristMotor.getPulseWidthPosition();
	int wristPickupPosition = wristHoldPosition + 16000;
	int wristSpitOutPosition = wristHoldPosition - 36300;
	int elbowHoldPosition = pickupElbowMotor.getPulseWidthPosition();
	int elbowPickupPosition = elbowHoldPosition + 37500;
	int elbowSpitOutPosition = elbowHoldPosition + 12219;
