...
public class sallyPort extends Command {
    ...
    protected void initialize() {
    	Robot.manipulatorArm.setManipulatorElbowMode(6);
    	Robot.manipulatorArm.setManipulatorWristMode(6);
    	Robot.manipulatorArm.comboindex = 2;
    ...
    protected void execute() {
    	if(Robot.manipulatorArm.lookup(time)) {
    		...
    		System.out.println(time + ", " + wristPosition + ", " + wristSpeed + ", " + elbowPosition + ", " + elbowSpeed + ", ");
