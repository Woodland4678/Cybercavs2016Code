 ...
 *
 */
public class CalibratePickup extends Command {
    ...
    protected void initialize() {
		...
		/*Robot.pickupArm.testPickupWheelsMove(-4.5f);
    	...
    	Robot.pickupArm.testWristMove(2.5f);
    	...
    	Robot.pickupArm.testElbowMove(-4.5f);
